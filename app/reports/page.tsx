...
export default function ReportsPage() {
  ...
  const generateReportHTML = () => {
    ...
    return `
      ...
      <html>
        <head>
          <title>CMMS Dashboard Report - ${currentDate}</title>
          <style>
            * {
              margin: 0;
              padding: 0;
        ...
        <body>
          <div class="report-container">
            ...
            <div class="footer">
              <p>This report was automatically generated by the CMMS Dashboard System</p>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              ...
              <CardContent>
                ...
                <div className="mt-4 h-32 w-full">
                  <ChartContainer config={chartConfig} className="w-full h-full">
                    <RechartsLineChart data={costTrendData} width="100%" height="100%">
            ...
            <Card className="transition-all duration-300 hover:shadow-md">
              ...
              <CardContent>
                ...
                <div className="mt-4 h-32 w-full">
                  <ChartContainer config={chartConfig} className="w-full h-full">
                    <RechartsBarChart data={completionRateData} width="100%" height="100%">
                      <CartesianGrid strokeDasharray="3 3" />
            ...
            <Card className="transition-all duration-300 hover:shadow-md">
              ...
              <CardContent>
                ...
                <div className="mt-4 h-32 w-full">
                  <ChartContainer config={chartConfig} className="w-full h-full">
                    <AreaChart data={uptimeData} width="100%" height="100%">
                      <CartesianGrid strokeDasharray="3 3" />
